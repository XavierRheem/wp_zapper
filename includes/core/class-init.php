...
namespace Zapper_NS\Includes\Core;
use Zapper_NS as NS;
use Zapper_NS\Admin as Admin;
use Zapper_NS\Includes\Frontend as Frontend;
...
class Init {
	 ...
	 * of the plugin.
	 *
	 * Callbacks are documented in/admin/class-admin.php
	 * 
	 * @access    private
	 */
